...
export function initialize(server: McpServer, client: OBSWebSocketClient): void {
  ...
  registerObsRequestTool(server, client, {
    ...
    successMessage: ({ realm, slotName }) => `Successfully set value for slot '${slotName}' in realm '${realm}'`,
  });

  // GetSceneCollectionList tool
  registerObsRequestTool(server, client, {
    name: "obs-get-scene-collection-list",
  ...
  registerObsRequestTool(server, client, {
    name: "obs-set-current-scene-collection",
    ...
    annotations: { readOnlyHint: false, destructiveHint: false, idempotentHint: true, openWorldHint: false },
    successMessage: ({ sceneCollectionName }) => `Successfully switched to scene collection: ${sceneCollectionName}`,
  });

  // CreateSceneCollection tool
  registerObsRequestTool(server, client, {
    name: "obs-create-scene-collection",
    ...
    successMessage: ({ sceneCollectionName }) => `Successfully created and switched to scene collection: ${sceneCollectionName}`,
  });

  // GetProfileList tool
  registerObsRequestTool(server, client, {
    name: "obs-get-profile-list",
  ...
  registerObsRequestTool(server, client, {
    ...
    annotations: { readOnlyHint: false, destructiveHint: false, idempotentHint: true, openWorldHint: false },
    successMessage: ({ profileName }) => `Successfully switched to profile: ${profileName}`,
  });

  // CreateProfile tool
  registerObsRequestTool(server, client, {
    name: "obs-create-profile",
    ...
    annotations: { readOnlyHint: false, destructiveHint: false, idempotentHint: false, openWorldHint: false },
    successMessage: ({ profileName }) => `Successfully created and switched to profile: ${profileName}`,
  });

  // RemoveProfile tool
  registerObsRequestTool(server, client, {
    name: "obs-remove-profile",
    ...
    successMessage: ({ profileName }) => `Successfully removed profile: ${profileName}`,
  });

  // GetProfileParameter tool
  registerObsRequestTool(server, client, {
    name: "obs-get-profile-parameter",
  ...
  registerObsRequestTool(server, client, {
    name: "obs-get-stream-service-settings",
  ...
  registerObsRequestTool(server, client, {
    name: "obs-set-stream-service-settings",
    ...
    annotations: { readOnlyHint: false, destructiveHint: false, idempotentHint: true, openWorldHint: false },
    successMessage: ({ streamServiceType }) => `Successfully updated stream service settings to type: ${streamServiceType}`,
  });

  // GetRecordDirectory tool
  registerObsRequestTool(server, client, {
    name: "obs-get-record-directory",
  ...
  registerObsRequestTool(server, client, {
    ...
    annotations: { readOnlyHint: false, destructiveHint: false, idempotentHint: true, openWorldHint: false },
    successMessage: ({ recordDirectory }) => `Successfully set record directory to: ${recordDirectory}`,
  });
}
